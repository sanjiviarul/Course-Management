    ...
    <form className="" action="studentadded" onSubmit={onSubmitForm}>
      ...
      <p>
        ...
        <div className="">
          ...
          <button className=" w-25 position-absolute btn-lg btn btn-primary" style={{'bottom':'10%', 'left':'50%', 'transform':'translateX(-50%)','backgroundColor':'pink!important'}}  type="submit" >Register now</button>
